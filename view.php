...
// $key = $_GET['post'];
$id = $_GET['id'];
$sql = "SELECT * FROM `blogpost` INNER JOIN `user` ON `blogpost`.post_id = '{$id}' AND `user`.`user_email` = '{$email}'";
...
<?php foreach ($result as $r) : ?>
  ...
  <body>
    ...
    <div class="card border-0 shadow blog">
      <div class="card-img-top d-flex px-5 align-items-center text-white" style="background: linear-gradient(rgba(0,0,0,.75), rgba(0,0,0,.5)), url(libs/img/<?= $r['post_header'] ?>); min-height: 75vh; background-size: cover; background-position: center center; background-attachment: fixed;">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="" method="post">
                      ...
                      <div class="form-group">
                        <textarea name="comment" id="editor" cols="30" rows="10" placeholder="Your Comment..."></textarea>
                      </div>
